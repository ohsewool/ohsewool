...
| [**modelmate**](https://github.com/ohsewool/modelmate) | 비전문가용 모델링 도우미 — 증거가 없으면 확신하지 않는 리포트 | 862 |
...
**초록불이 실제로 확인한 결과가 아니었던 것** — 처음 여섯 번은 이랬다. 그 뒤로도 계속 나왔고, 지금은 [FINDINGS.md](FINDINGS.md)의 60개 중 아홉 항목이 이 낱말을 쓴다.
...
훑었고, 기록은 [**FINDINGS.md**](FINDINGS.md)에 있다 — **60개 항목**, 앞에 [결함의 모양](FINDINGS.md#결함의-모양) 여덟 가지로 색인을 달아뒀다.
